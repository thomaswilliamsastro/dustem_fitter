...
fluxes = 'fluxes_m33.csv' #Path to pandas dataframe containing fluxes
filters = ['Spitzer_3.6','Spitzer_4.5',
           ...
           'PACS_100','PACS_160',
           'SPIRE_250',
           'SPIRE_350','SPIRE_500','Planck_850']
           #'SCUBA2_450','SCUBA2_850'] #List of filters to include

###Dust Model Parameters###

method = 'default' #Options are default, abundfree and ascfree
